...
TEST(BranchCoverage, BxExceptionReturn)
{
    ...
    mock_memory[0x102] = 0x00; mock_memory[0x103] = 0x00;  /* R0 */
    mock_memory[0x104] = 0x00; mock_memory[0x105] = 0x00;
    mock_memory[0x106] = 0x00; mock_memory[0x107] = 0x00;  /* R1 */
    mock_memory[0x108] = 0x00; mock_memory[0x109] = 0x00;
    mock_memory[0x10A] = 0x00; mock_memory[0x10B] = 0x00;  /* R2 */
    mock_memory[0x10C] = 0x00; mock_memory[0x10D] = 0x00;
    mock_memory[0x10E] = 0x00; mock_memory[0x10F] = 0x00;  /* R3 */
    mock_memory[0x110] = 0x00; mock_memory[0x111] = 0x00;
    mock_memory[0x112] = 0x00; mock_memory[0x113] = 0x00;  /* R12 */
    mock_memory[0x114] = 0x00; mock_memory[0x115] = 0x00;
    mock_memory[0x116] = 0x00; mock_memory[0x117] = 0x00;  /* LR */
    mock_memory[0x118] = 0x01; mock_memory[0x119] = 0x10;
    mock_memory[0x11A] = 0x00; mock_memory[0x11B] = 0x00;  /* Return PC = 0x1001 */
    mock_memory[0x11C] = 0x00; mock_memory[0x11D] = 0x00;
    mock_memory[0x11E] = 0x00; mock_memory[0x11F] = 0x01;  /* xPSR with T bit */
