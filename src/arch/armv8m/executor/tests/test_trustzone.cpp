...
TEST(TZ_SAU, SAU_NSCRegion)
{
    ...
    exec.sau.regions[1].rlar = 0x30000FFF | ARMV8M_SAU_RLAR_ENABLE | ARMV8M_SAU_RLAR_NSC;
...
TEST(TZ_TT, TT_ReturnsNSCForNSCRegion)
{
    ...
    exec.sau.regions[0].rlar = 0x3000FFFF | ARMV8M_SAU_RLAR_ENABLE | ARMV8M_SAU_RLAR_NSC;
