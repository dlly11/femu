...
static void armv8m_executor_set_memory(EmuExecutor *exec,
   ...
   */
  /* For now, just store the context - full integration would need wrapper
   * callbacks */
  (void)mem;
}
...
static int armv8m_executor_exec_insn(EmuExecutor *exec,
