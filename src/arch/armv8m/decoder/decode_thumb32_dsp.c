...
int decode_parallel_add_sub(uint16_t hw1, uint16_t hw2, DecodedInsn *out) {
   ...
   * hw2 = 0b1111_dddd_0TTT_mmmm (TTT determines
   * signed/unsigned/halving/saturating)
   *
...
int decode_misc_ops(uint16_t hw1, uint16_t hw2, DecodedInsn *out) {
  ...
  case 0x1:
    ...
    case 0x0:
      out->op = DP_ROR;
      out->shift_amount = 0x10;
      break; /* REV */
    case 0x1:
      out->op = DP_ROR;
      out->shift_amount = 0x11;
      break; /* REV16 */
    case 0x2:
      out->op = DP_ROR;
      out->shift_amount = 0x12;
      break; /* RBIT */
    case 0x3:
      out->op = DP_ROR;
      out->shift_amount = 0x13;
      break; /* REVSH */
    default:
      return ARMV8M_ERR_UNDEFINED_INSN;
    }
