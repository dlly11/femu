...
class EmulatorLib(Protocol):
    ...
    def armv8m_emu_load(
        self, emu: CData, addr: int, data: bytes, size: int
    ) -> int: ...
    ...
    # Memory Access API
    def armv8m_emu_read_mem(
        self, emu: CData, addr: int, size: int, fault: CData
    ) -> int: ...
    def armv8m_emu_write_mem(
        self, emu: CData, addr: int, value: int, size: int, fault: CData
    ) -> None: ...
    def armv8m_emu_read_block(
        self, emu: CData, addr: int, data: CData, size: int
    ) -> int: ...
    def armv8m_emu_write_block(
        self, emu: CData, addr: int, data: bytes, size: int
    ) -> int: ...
    ...
    def armv8m_emu_set_special_reg(
        self, emu: CData, reg: int, value: int
    ) -> None: ...
    def armv8m_emu_get_fpu_reg(self, emu: CData, reg: int) -> int: ...
    def armv8m_emu_set_fpu_reg(
        self, emu: CData, reg: int, value: int
    ) -> None: ...
