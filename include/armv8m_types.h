...
#define ARMV8M_CCR_BFHFNMIGN    (1U << 8)   /* Ignore BusFault during HardFault/NMI */
...
#define ARMV8M_MMFSR_MLSPERR    (1U << 5)   /* MemManage on lazy FP state preservation */
...
#define ARMV8M_BFSR_LSPERR      (1U << 13)  /* BusFault on lazy FP state preservation */
...
#define ARMV8M_SAU_CTRL_ALLNS   (1U << 1)   /* All memory non-secure when SAU disabled */
...
typedef enum {
    ...
    MUL_SMMLAR,         /* SMMLAR - signed most significant word multiply-accumulate (round) */
