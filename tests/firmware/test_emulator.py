...
from femu.emulator import ARMv8MConfig, ARMv8MEmulator, EmulatorState
    ...
    try:
        ...
        for addr, expected_val in expected.items():
            ...
            if actual_val == expected_val:
                ...
                print(
                    f"    [0x{addr:08x}] = 0x{actual_val:08x} FAIL (expected 0x{expected_val:08x})"
                )
                all_pass = False
